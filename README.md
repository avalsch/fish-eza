...
A fork of [`gazorby/fish-exa`](https://github.com/gazorby/fish-exa) which excludes
existing commands which are overriden, such as `ld`.
...
```console
fisher install avalsch/fish-eza
```
...
[MIT](https://github.com/avalsch/fish-eza/blob/master/LICENSE)
